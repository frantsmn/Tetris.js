...
class Textures {
    constructor() {
        ...
        for (let i = 0; i <= 9; i++) {
            ...
            this.textures[i].type1.src = `/textures/level_${i}/type_1.svg`;
            this.textures[i].type2.src = `/textures/level_${i}/type_2.svg`;
            this.textures[i].type3.src = `/textures/level_${i}/type_3.svg`;
        }

        // this[1] = this.textures[this.level].type1;
        // this[2] = this.textures[this.level].type2;
        // this[3] = this.textures[this.level].type3;
    ...
    set level(value) {
        this._level = value;
        this[1] = this.textures[value].type1;
        this[2] = this.textures[value].type2;
        this[3] = this.textures[value].type3;
    }
...
class Stats {
    ...
    refresh() {
        ...
        //Следующий блок
        this.element.querySelector('img#nextBlock').src = `/img/blocks/${block.nextBlock.name}.png`;
        //Стертые линии
...
class Control {
    constructor() {
            ...
            switch (e.keyCode) {
                ...
                case 40:
                    ...
                    this.shiftRepeatInterval = setInterval(() => {
                        ...
                        //Сообщаем о зажатой клавише вниз (необходимо для подсчета строк, за которые дропнется блок)
        ...
        emitter.subscribe("canvas:wipeAnimationEnd", () => this.startListenKeyboard());
    }
...
// let matrix = new Matrix('[[null,null,null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null,null,null],[null,{"state":"fixed","color":2},null,null,null,null,null,null,null,null],[null,{"state":"fixed","color":2},null,null,null,null,null,null,null,null],[{"state":"fixed","color":2},{"state":"fixed","color":2},null,null,null,null,null,null,null,null],[{"state":"fixed","color":3},{"state":"fixed","color":2},null,{"state":"fixed","color":1},{"state":"fixed","color":1},null,null,null,null,null],[{"state":"fixed","color":3},{"state":"fixed","color":2},{"state":"fixed","color":2},{"state":"fixed","color":1},{"state":"fixed","color":1},{"state":"fixed","color":1},null,null,{"state":"fixed","color":3},null],[{"state":"fixed","color":3},{"state":"fixed","color":3},{"state":"fixed","color":2},{"state":"fixed","color":3},{"state":"fixed","color":1},{"state":"fixed","color":1},null,{"state":"fixed","color":3},{"state":"fixed","color":3},null],[{"state":"fixed","color":2},{"state":"fixed","color":3},{"state":"fixed","color":3},{"state":"fixed","color":3},{"state":"fixed","color":1},{"state":"fixed","color":1},null,{"state":"fixed","color":3},{"state":"fixed","color":1},null],[{"state":"fixed","color":2},{"state":"fixed","color":2},{"state":"fixed","color":2},{"state":"fixed","color":1},{"state":"fixed","color":1},{"state":"fixed","color":1},null,{"state":"fixed","color":1},{"state":"fixed","color":1},{"state":"fixed","color":1}]]');
